...
namespace FloraEjemplo.ViewModels
{
    ...
    {
        public List<Productores> _Productores { get; set; }
        ...
        public AgendaViewModel()
        {
            ...
            _Productores = new List<Productores>();
            LoadProductores();
            LoadDolarToday();
            //Nuevo = new Command(() => {
            //    Nombre = "";
            ...
            {
                _Productores.Add(new Productores()
                {
                    Nombre = "Alejando Navarro",
                    Sector = "Grupo Las Esperanzas",
                    Locacion = "Provincia/Problación/Municipio",
                    Imagen = "user"
                });
            ...
            async void LoadDolarToday()
            {
                try
                {
                    foreach (var item in _Productores)
                    {
                        var fila = item as Productores;
                        if (item.Nombre == "Ana Fuentes")
                        {
